...
Connecting Brands to the Right Voices
...
bolt relies extensively on environment settings which **will not work with Apache/mod_wsgi setups**. It has been deployed successfully with both Gunicorn/Nginx and even uWSGI/Nginx.

For configuration purposes, the following table maps the 'bolt' environment variables to their Django setting:
...
DJANGO_DEFAULT_FROM_EMAIL               DEFAULT_FROM_EMAIL          n/a                                            "bolt <noreply@boltmedia.co>"
DJANGO_SERVER_EMAIL                     SERVER_EMAIL                n/a                                            "bolt <noreply@boltmedia.co>"
DJANGO_EMAIL_SUBJECT_PREFIX             EMAIL_SUBJECT_PREFIX        n/a                                            "[bolt] "
======================================= =========================== ============================================== ======================================================================
...
To run the tests, enter the bolt/tests directory and run the following commands::
...
application stacks on one host, remove the port setting entirely and add `VIRTUAL_HOST=boltmedia.co` to your env file.
This pass all incoming requests on `nginx-proxy` to the nginx service your application is using.

.. _nginx-proxy: https://github.com/jwilder/nginx-proxy

Postgres is saving its database files to `/data/bolt/postgres` by default. Change that if you wan't
...
Place it in `/etc/supervisor/conf.d/bolt.conf` and run::

    supervisorctl reread
    supervisorctl start bolt
