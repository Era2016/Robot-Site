...
# stored files.
MEDIA_URL = 'http://%s/%s/' % (AWS_S3_HOST, AWS_STORAGE_BUCKET_NAME)
...
DEFAULT_FROM_EMAIL = env('DJANGO_DEFAULT_FROM_EMAIL',
                         default='bolt <noreply@boltmedia.co>')
EMAIL_BACKEND = 'django_mailgun.MailgunBackend'
MAILGUN_ACCESS_KEY = env('DJANGO_MAILGUN_API_KEY')
MAILGUN_SERVER_NAME = env('DJANGO_MAILGUN_SERVER_NAME')
EMAIL_SUBJECT_PREFIX = env("DJANGO_EMAIL_SUBJECT_PREFIX", default='[bolt] ')
...
# ANGULAR
# ------------------------------------------------------------------------------
ANGULAR_BUILD_DIR = str(ANGULAR_DIR.path('bin'))
